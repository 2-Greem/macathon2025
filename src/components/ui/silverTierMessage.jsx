...
export default function SilverTierMessage({ message, votedMessages, isRating, handleRate }){
    ...
    return <div key={message.message_id} className="bg-gradient-to-br from-yellow-200 via-yellow-400 to-yellow-200 p-3 rounded-lg border--4 border-1 border-yellow-500">
              <p className="text-slate-800 mb-2"><b>{message.content}</b></p>
