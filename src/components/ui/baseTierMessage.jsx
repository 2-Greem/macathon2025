...
export default function BaseTierMessage({ message, votedMessages, isRating, handleRate }){
    ...
    return <div key={message.message_id} className="bg-zinc-800 p-3 rounded-lg border-l-4 border-orange-500">
